...
def get_all_register():
    try:
        data = CrudFunctions.get_all_register('23_13311300000000_04')
...
def get_one_register(id:str):
    try:
        data = CrudFunctions.get_single_register('23_13311300000000_04',id,where='edadResistencia')
...
def post_regsiter(item:edad_resistencia_model):
    try:
        id =  CrudFunctions.post_register('23_13311300000000_04',item,True)
...
def put_register(id:str,body:edad_resistencia_model):
    try:
        item  = CrudFunctions.put_register('23_13311300000000_04',id,body,'edadResistencia')
        print('*************',item)
...
def get_one_register(id:str):
    try:
        data = CrudFunctions.delete_register('23_13311300000000_04',id,True,where='edadResistencia')
        if data > 0:
